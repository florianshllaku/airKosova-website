...
const AK_TRANSLATIONS = {
  ...
  sq: {
    ...
    nav_contact: 'Kontakt',
    nav_siguria: 'Siguria',
    nav_para_udhetimit: 'Para Udhëtimit',
    nav_e_biletat: 'E-Biletat',
    nav_bagazhi: 'Bagazhi',
    nav_shendeti: 'Shëndeti',

    // Homepage Hero
    hero_headline: 'Bota është e gjerë, plot me histori që presin të jetohen.',
    hero_subline: 'Le të të çojë AirKosova atje.',
    ...
    field_return: 'Kthimi',
    field_adults: 'Të rritur',
    field_children: 'Fëmijë (2-11)',
    field_infants: 'Foshnja (0-2)',
    trip_roundtrip: 'Vajtje-Ardhje',
    trip_oneway: 'Vetëm Vajtje',
    prices_eur: 'Të gjitha çmimet në EUR',
    ...
    login_email_required: 'Ju lutem shkruani email-in tuaj për t’u kyçur.',
    register_title: 'Krijo Llogari',
    register_subtitle: 'Regjistrohu për të rezervuar dhe menaxhuar fluturime',
    register_email: 'Email',
    register_password: 'Fjalëkalimi',
    register_confirm: 'Konfirmo Fjalëkalimin',
    register_btn: 'Krijo Llogari',
    register_have_account: 'Keni tashmë një llogari?',
    register_login: 'Hyr',
    forgot_title: 'Rivendos Fjalëkalimin',
    forgot_subtitle: 'Shkruani email-in tuaj për të marrë linkun e rivendosjes',
    forgot_email: 'Email',
    forgot_btn: 'Dërgo Linkun',
    forgot_back: '← Kthehu te Hyrja',
    welcome_title: 'Mirë se erdhe!',
    logout_btn: 'Dil',

    // Features Section
    features_title: 'Pse të zgjidhni AirKosova?',
    features_subtitle: 'Më shumë se 10 vite eksperiencë në industrinë e aviacionit',
    feature1_title: '10+ Vite Përvojë',
    feature1_desc: 'I besuar nga mijëra udhëtarë që nga 2014. Shërbim i sigurt, i besueshëm dhe profesional.',
    feature2_title: 'Rezervim i Lehtë Online',
    feature2_desc: 'Rezervoni fluturimet tuaja në minuta me sistemin tonë të thjeshtë. Pagesa të sigurta me Visa dhe Mastercard.',
    feature3_title: 'Mbështetje 24/7',
    feature3_desc: 'Ekipi ynë i dedikuar është gjithmonë gati t\'ju ndihmojë me çdo pyetje ose ndryshim rezervimi.',

    // Destinations
    destinations_title: 'Destinacionet Popullore',
    destinations_desc: 'Fluturime direkte në qytetet më të njohura Europiane',

    // Footer
    footer_prishtina: 'Zyra në Prishtinë',
    footer_london: 'Zyra në Londër',
    footer_payment: 'Metodat e Pagesës',
    footer_languages: 'Gjuhët',

    // Results Page
    results_title: 'Rezultatet e Fluturimeve',
    results_subtitle: 'Zgjidhni fluturimet tuaja',
    searching: 'Duke kërkuar fluturime të disponueshme...',
    searching_hint: 'Kjo mund të zgjasë disa sekonda.',
    no_search_in_progress: 'Nuk ka kërkim aktiv. Ju lutem filloni një kërkim të ri.',
    session_expired: 'Sesioni i kërkimit ka skaduar. Ju lutem filloni një kërkim të ri.',
    something_went_wrong: 'Diçka shkoi keq. Ju lutem filloni një kërkim të ri.',
    search_again: 'Kërko Përsëri',
    ...
    click_to_select: 'Klikoni për të zgjedhur',
    loading_flights: 'Duke kërkuar fluturimet më të mira...',
    no_flights: 'Nuk u gjetën fluturime',
    price_per_person: 'Çmimi / person',

    // Booking Page
    step_login: 'Llogaria',
    step_passengers: 'Pasagjerët',
    step_payment: 'Pagesa',
    account_title: 'Llogaria Juaj',
    account_desc: 'Hyni ose krijoni një llogari për të vazhduar me rezervimin',
    ...
    field_confirm_password: 'Konfirmo Fjalëkalimin',
    btn_register: 'Krijo Llogari',
    or_continue: 'ose vazhdoni si mysafir',
    btn_guest: 'Vazhdo pa Llogari',
    passengers_title: 'Detajet e Pasagjerëve',
    passengers_desc: 'Plotësoni të dhënat për të gjithë pasagjerët',
    coupon_title: 'Keni kod promocional?',
    btn_apply: 'Apliko',
    btn_continue_payment: 'Vazhdo te Pagesa',
    payment_title: 'Pagesa',
    payment_desc: 'Përfundoni rezervimin tuaj duke paguar me kartë krediti',
    payment_notice: 'Pagesa online është përkohësisht e çaktivizuar. Rezervimi juaj do të ruhet dhe mund të paguani më vonë.',
    field_card_number: 'Numri i Kartës',
    field_expiry: 'Skadenca',
    field_cvv: 'CVV',
    field_cardholder: 'Mbajtësi i Kartës',
    terms_agree: 'Pranoj kushtet e shërbimit dhe politikën e privatësisë',
    btn_complete: 'Përfundo Rezervimin',
    confirmation_title: 'Rezervimi u Krua me Sukses!',
    confirmation_desc: 'Faleminderit për rezervimin tuaj. Do të merrni një email konfirmimi së shpejti.',
    booking_ref: 'Numri i Rezervimit:',
    btn_back_home: 'Kthehu në Faqen Kryesore',
    flight_summary: 'Përmbledhja e Fluturimit',
    adults: 'Të rritur',
    children: 'Fëmijë (2-11)',
    infants: 'Foshnja (0-2)',
    discount: 'Zbritje',
    secure_booking: 'Rezervim i Sigurt',
    secure_desc: 'Të dhënat tuaja janë të mbrojtura me enkriptim SSL',
    adult: 'I rritur',
    child: 'Fëmijë',
    infant: 'Foshnjë',
    field_dob: 'Data e Lindjes',
    welcome_logged_in: 'Mirë se erdhe!',
    logged_in_desc: 'Ju jeni kyçur. Vazhdoni me rezervimin.',
    btn_continue: 'Vazhdo',
    btn_logout: 'Dil nga Llogaria',
    signing_in: 'Duke u kyçur...',
    creating_account: 'Duke krijuar llogari...',
    passwords_not_match: 'Fjalëkalimet nuk përputhen',
    auth_not_configured: 'Autentikimi nuk është konfiguruar',
    check_email: 'Kontrolloni email-in tuaj për të konfirmuar llogarinë!',
    account_created: 'Llogaria u krijua me sukses!',
    enter_email: 'Shkruani email-in tuaj:',
    reset_email_sent: 'Email i dërguar! Kontrolloni inbox-in tuaj.',

    // Contact Page
    contact_title: 'Kontakt',
    contact_subtitle: 'Na kontaktoni për çdo pyetje rreth fluturimeve dhe rezervimeve',
    contact_phone: 'Telefononi',
    contact_email_title: 'E-mail',
    contact_address: 'Adresa',
    contact_whatsapp: 'Na shkruani në WhatsApp',
    support_24h: 'Support 24h',

    // Info Pages
    info_siguria_title: 'Siguria',
    info_siguria_subtitle: 'Gjësende të rrezikshme / Dangerous Goods',
    info_para_title: 'Para Udhëtimit',
    info_para_subtitle: 'Informacione të rëndësishme para fluturimit',
    info_ebiletat_title: 'E-Biletat',
    info_ebiletat_subtitle: 'Biletat Elektronike',
    info_bagazhi_title: 'Bagazhi',
    info_bagazhi_subtitle: 'Informacione rreth bagazhit të dorëzuar dhe të dorës',
    info_shendeti_title: 'Shëndeti',
    info_shendeti_subtitle: 'Informacione shëndetësore për udhëtarët',

    // E-Biletat Page Content
    ebiletat_intro: 'Bileta elektronike, e shkurtuar E-Biletë, është një biletë që mund të përdoret si zëvendësim elektronik për biletat prej letre. 92 përqind e të gjitha biletave të fluturimit të lëshuara në botë ishin elektronike sipas vlerësimit të International Air Transport Association në dhjetor 2007.',
    ebiletat_airkosova: 'Natyrisht mund të fluturoni edhe me E-Bileta në O.T.A Airkosova Network SH.P.K.!',
    ebiletat_how_title: 'Si funksionon?',
    ebiletat_how_text1: 'Te ne fluturimi pa letër me E-Biletë funksionon shumë thjesht:',
    ebiletat_how_text2: 'Rezervoni me telefon ose online përmes internetit, drejtpërdrejt te O.T.A Airkosova Network SH.P.K. ose në agjencitë tona të udhëtimit. Kur blini një E-Biletë, identiteti juaj dhe të dhënat (e udhëtimit) regjistrohen. Numrin e rezervimit do ta merrni ose me telefon ose me shkrim përmes postës, faksit ose e-mailit.',
    ebiletat_benefits_title: 'Përparësitë e E-Biletave',
    ebiletat_benefit1_title: 'Nuk Humbet',
    ebiletat_benefit1_text: 'Nuk mund t\'i humbni biletat tuaja, dhe as nuk mund t\'ju vidhen.',
    ebiletat_benefit2_title: 'Ndryshime të Shpejta',
    ebiletat_benefit2_text: 'Ndryshimet e rezervimit mund të bëhen më shpejt - mjafton një telefonatë.',
    ebiletat_benefit3_title: 'Kurseni Kohë',
    ebiletat_benefit3_text: 'Përveç kësaj, nëse nuk keni bagazh për të dorëzuar, mund të shmangni radhën në sportelin e check-in.',
    ebiletat_benefit4_title: 'Identifikimi',
    ebiletat_benefit4_text: 'Kur të përdorni biletën, duhet të dëshmoni identitetin tuaj, për shembull me pasaportën tuaj.',
  ...
  de: {
    ...
    register_subtitle: 'Registrieren Sie sich, um Flüge zu buchen',
    ...
    // Features Section
    features_title: 'Warum AirKosova wählen?',
    features_subtitle: 'Mehr als 10 Jahre Erfahrung in der Luftfahrtindustrie',
    feature1_title: '10+ Jahre Erfahrung',
    feature1_desc: 'Von tausenden Reisenden seit 2014 vertraut. Sicherer, zuverlässiger und professioneller Service.',
    feature2_title: 'Einfache Online-Buchung',
    feature2_desc: 'Buchen Sie Ihre Flüge in Minuten mit unserem einfachen Buchungssystem. Sichere Zahlung mit Visa und Mastercard.',
    feature3_title: '24/7 Kundensupport',
    feature3_desc: 'Unser engagiertes Team ist immer bereit, Ihnen bei Fragen oder Buchungsänderungen zu helfen.',

    // Destinations
    destinations_title: 'Beliebte Reiseziele',
    destinations_desc: 'Direktflüge zu den beliebtesten europäischen Städten',

    // Footer
    footer_prishtina: 'Büro Prishtina',
    footer_london: 'Büro London',
    footer_payment: 'Zahlungsmethoden',
    footer_languages: 'Sprachen',

    // Results Page
    results_title: 'Flugergebnisse',
    results_subtitle: 'Wählen Sie Ihre Flüge',
    searching: 'Suche nach verfügbaren Flügen...',
    ...
    select_flight: 'Flug auswählen',
    click_to_select: 'Klicken zum Auswählen',
    loading_flights: 'Suche nach den besten Flügen...',
    ...
    payment_desc: 'Schließen Sie Ihre Buchung mit Kreditkartenzahlung ab',
    payment_notice: 'Online-Zahlung ist vorübergehend deaktiviert. Ihre Buchung wird gespeichert.',
    ...
    btn_complete: 'Buchung abschließen',
    confirmation_title: 'Buchung erfolgreich!',
    confirmation_desc: 'Vielen Dank für Ihre Buchung. Sie erhalten in Kürze eine Bestätigungs-E-Mail.',
    booking_ref: 'Buchungsnummer:',
    btn_back_home: 'Zurück zur Startseite',
    flight_summary: 'Flugübersicht',
    adults: 'Erwachsene',
    children: 'Kinder (2-11)',
    infants: 'Babys (0-2)',
    discount: 'Rabatt',
    secure_booking: 'Sichere Buchung',
    secure_desc: 'Ihre Daten sind durch SSL-Verschlüsselung geschützt',
    adult: 'Erwachsener',
    child: 'Kind',
    infant: 'Baby',
    field_dob: 'Geburtsdatum',
    welcome_logged_in: 'Willkommen zurück!',
    ...
    check_email: 'Überprüfen Sie Ihre E-Mail zur Bestätigung!',
    account_created: 'Konto erfolgreich erstellt!',
    enter_email: 'Geben Sie Ihre E-Mail ein:',
    reset_email_sent: 'E-Mail gesendet! Überprüfen Sie Ihren Posteingang.',

    // Contact Page
    contact_title: 'Kontakt',
    contact_subtitle: 'Kontaktieren Sie uns bei Fragen zu Flügen und Buchungen',
    ...
    info_siguria_subtitle: 'Sicherheitsinformationen für Ihre Reise',
    ...
    info_bagazhi_title: 'Gepäck',
    info_bagazhi_subtitle: 'Informationen zum erlaubten Gepäck',
    info_shendeti_title: 'Gesundheit',
    info_shendeti_subtitle: 'Gesundheitstipps für Reisende',

    // E-Biletat Page Content
    ebiletat_intro: 'Ein elektronisches Ticket, kurz E-Ticket, ist ein Ticket, dass als elektronischer Ersatz für Tickets aus Papier Verwendung finden kann. 92 Prozent aller weltweit ausgestellten Flugtickets waren nach einer Schätzung der International Air Transport Association im Dezember 2007 elektronisch.',
    ebiletat_airkosova: 'Selbstverständlich können Sie auch bei O.T.A Airkosova Network SH.P.K. mit E-Tickets fliegen!',
    ...
    ebiletat_how_text2: 'Sie buchen per Telefon oder online via Internet, entweder direkt bei O.T.A Airkosova Network SH.P.K. oder in unseren Reisebüros. Beim Kauf eines E-Tickets wird Ihre Identität und Ihre (Reise-) Daten registriert. Ihre Buchungsnummer erhalten Sie entweder telefonisch oder schriftlich per Post, Fax oder E-Mail.',
    ebiletat_benefits_title: 'Vorteile von E-Tickets',
    ebiletat_benefit1_title: 'Geht nicht verloren',
    ebiletat_benefit1_text: 'Sie können Ihre Tickets nicht verlieren, es kann Ihnen auch nicht gestohlen werden.',
    ebiletat_benefit2_title: 'Schnelle Änderungen',
    ebiletat_benefit2_text: 'Umbuchungen lassen sich schneller erledigen – Anruf genügt.',
    ebiletat_benefit3_title: 'Zeit sparen',
    ebiletat_benefit3_text: 'Außerdem können Sie sich, sofern kein Gepäck aufzugeben ist, das Schlangestehen am Check-in-Schalter sparen.',
    ebiletat_benefit4_title: 'Identifikation',
    ebiletat_benefit4_text: 'Beim Einlösung des Tickets müssen Sie Ihre Identität, beispielsweise anhand Ihres Passes nachweisen.',
  ...
  en: {
    ...
    ebiletat_benefit2_text: 'Rebookings can be done faster – a phone call is all it takes.',
...
function initLanguageSwitcher() {
  document.querySelectorAll('.topbar-lang').forEach(btn => {
    btn.addEventListener('click', (e) => {
      // Many language entries are rendered as <a href="#">…</a>
